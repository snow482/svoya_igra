...
export const refreshAccessToken = createAsyncThunk<AuthResponse, void, { rejectValue: RejectValue }>(
...
export const authorization = createAsyncThunk<AuthResponse, { email: string, password: string }, { rejectValue: RejectValue }> (
...
export const logout = createAsyncThunk<void, void, { rejectValue: RejectValue }>(
